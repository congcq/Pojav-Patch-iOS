...
- (id) initMGLRendererFromContext: (void *)glm_ctx andBindToWindow: (UIWindow *)window;
- (id) createMGLRendererFromContext: (void *)glm_ctx andBindToWindow: (UIWindow *)window;
